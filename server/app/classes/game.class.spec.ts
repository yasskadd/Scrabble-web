...
describe('Game tests', () => {
    ...
    let dictionaryValidation: SinonStubbedInstance<DictionaryValidationService> & DictionaryValidationService;
    let wordSolver: SinonStubbedInstance<WordSolverService> & WordSolverService;
    let game: Game;
